...
<head>
    ...
    <link rel="stylesheet" href="style.css">
        ...
        function updateTime() {
            ...
            var UTCtime = time.toLocaleString("en-US", {
                hour: '2-digit',
                minute: '2-digit',
                second: '2-digit',
                hour12: true,
            ...
            document.getElementById("local-time").innerHTML = `${localTime} ET`;
            document.getElementById("utc-time").innerHTML = `${UTCtime} UTC`;
        }
...
<div>
<img src='part1.jpg'><BR><img src='part2.jpg'>
        </div>
